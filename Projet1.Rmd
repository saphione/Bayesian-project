...
logisitic <- function(){
  ...
  for (j in 1:nb){
    a[j] ~ dnorm(0,0.001) 
    b.bare[j] ~ dnorm(0,0.001)
    b.bare_carre[j] ~ dnorm(0,0.001)
    b.height[j] ~ dnorm(0,0.001)
    b.height_carre[j] ~ dnorm(0,0.001) 
  }
#
}

# initial values
init1 <- list(a = rep(0.5, datahoopoe$nb), b.bare = rep(0.5, datahoopoe$nb), b.bare_carre = rep(0.5, datahoopoe$nb), b.height = rep(0.5, datahoopoe$nb), b.height_carre = rep(0.5, datahoopoe$nb))
init2 <- list(a = rep(-0.5, datahoopoe$nb), b.bare = rep(-0.5, datahoopoe$nb), b.bare_carre = rep(-0.5, datahoopoe$nb), b.height = rep(-0.5, datahoopoe$nb), b.height_carre = rep(-0.5, datahoopoe$nb))
